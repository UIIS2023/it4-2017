...
public class DialogRectangle extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2714980974684453794L;
	...
	public DialogRectangle() {
		...
		btnInsideColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				insideColor = JColorChooser.showDialog(null, "Choose an inside color of your rectangle:", Color.BLACK);
			}
		});
		...
		btnBorderColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				borderColor = JColorChooser.showDialog(null, "Choose an outside color of your rectangle:", Color.BLACK);
			}
		});
