...
public class DialogPoint extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4147806765624175724L;
	...
	public DialogPoint() {
		...
		lblX = new JLabel("Enter X coordinate:");
		lblX.setFont(new Font("Calibri", Font.ITALIC, 20));

		lblY = new JLabel("Enter Y coordinate:");
		lblY.setFont(new Font("Calibri", Font.ITALIC, 20));
		...
		btnColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				color = JColorChooser.showDialog(null, "Choose a color of your point", null);
			}
		});
