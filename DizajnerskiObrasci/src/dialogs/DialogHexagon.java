...
public class DialogHexagon extends JDialog {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3646010289729527867L;
			...
			gl_contentPanel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPanel.createSequentialGroup()
					.addGroup(gl_contentPanel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_contentPanel.createSequentialGroup()
							.addContainerGap()
							.addComponent(btnInsideColor, GroupLayout.PREFERRED_SIZE, 117, GroupLayout.PREFERRED_SIZE))
						.addGroup(gl_contentPanel.createSequentialGroup()
							.addGap(32)
							...
							.addComponent(btnBorderColor, GroupLayout.DEFAULT_SIZE, 117, Short.MAX_VALUE)))
					.addGap(29))
		);
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							h.setHexagon(
									...
									Integer.parseInt(getTxtRadius()), getInsideColor(), getBorderColor());
